...
function library:Introduction()
    ...
    local barCorner = Instance.new("UICorner")
    local barLayout = Instance.new("UIListLayout")
    local rzxLogo = Instance.new("ImageLabel")
    local hashLogo = Instance.new("ImageLabel")
    local rzx = Instance.new("TextLabel")
    ...
    rzxLogo.Name = "rzxLogo"
    rzxLogo.Parent = background
    rzxLogo.AnchorPoint = Vector2.new(0.5, 0.5)
    rzxLogo.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    rzxLogo.BackgroundTransparency = 1.000
    rzxLogo.Position = UDim2.new(0.5, 0, 0.5, 0)
    rzxLogo.Size = UDim2.new(0, 448, 0, 150)
    rzxLogo.Visible = true
    rzxLogo.Image = "http://www.roblox.com/asset/?id=9365068051"
    rzxLogo.ImageColor3 = Color3.fromRGB(159, 115, 255)
    rzxLogo.ImageTransparency = 1
    ...
    rzx.Name = "rzx"
    rzx.Parent = background
    rzx.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    rzx.BackgroundTransparency = 1.000
    rzx.Size = UDim2.new(0, 80, 0, 21)
    rzx.Font = Enum.Font.Code
    rzx.Text = "powered by rzx"
    rzx.TextColor3 = Color3.fromRGB(124, 124, 124)
    rzx.TextSize = 10.000
    rzx.TextTransparency = 1
    ...
    CreateTween("rzxRotation", 0)
    local MinusAmount = -16
    coroutine.wrap(function()
        while wait() do
            MinusAmount = MinusAmount + 0.4
            TweenService:Create(rzxLogo, TweenTable["rzxRotation"], {Rotation = rzxLogo.Rotation - MinusAmount}):Play()
        end
    end)()
    ...
    wait(.2)
    TweenService:Create(rzx, TweenTable["introduction"], {TextTransparency = 0}):Play()
    TweenService:Create(text, TweenTable["introduction"], {TextTransparency = 0}):Play()
    wait(.3)
    TweenService:Create(rzxLogo, TweenTable["introduction"], {ImageTransparency = 0}):Play()
    wait(2)
    TweenService:Create(rzxLogo, TweenTable["introduction"], {ImageTransparency = 1}):Play()
    wait(.2)
    ...
    wait(.1)
    TweenService:Create(rzx, TweenTable["introduction"], {TextTransparency = 1}):Play()
    wait(.1)
